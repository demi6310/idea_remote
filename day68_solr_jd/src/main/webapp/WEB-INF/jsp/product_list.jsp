	...
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<form id="actionForm" action="/item/list" method="POST">
				<div class="form">
				...
				<input type="hidden" name="catelog_name" id="catelog_name" value="${catalog_name }"/>
...
<div id="filter">
	...
	<div class="fore1">
		...
		<div class="total">
			<span>共<strong>${result.totalCount }</strong>个商品
			</span>
		</div>
		<span class="clr"></span>
	</div>
